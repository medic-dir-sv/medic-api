...
namespace Medic.API.Migrations
{
    ...
    [Migration("20220701232945_RenameConsultationToAppointment")]
    partial class RenameConsultationToAppointment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Medic.Domain.Entities.Doctors.Speciality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Medic.Domain.Entities.Doctors.Doctor", b =>
                {
                    b.HasOne("Medic.Domain.Entities.Doctors.Speciality", "Specialty")
                        .WithMany()
